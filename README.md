...
<head>
    ...
    <title>MyfirstwebsiteDevelopment</title>
    <style>
        h1 {
            color: black;
            font-size: 45px;
...
<body>
    ...
    <h1 align="top">
        <div class="first">Easy Coding
            </div>
        <div class="second">The world's largest Coding learning website<br></div>
        <div class="third">~Path Way For Your Golden Career </div>
    </h1>
    <div class="d">
    ...
    <footer class="t">
        Designed and Developed by Charitha Kamireddy &copy; 2024
    </footer>
...
<body>
    <header>
        ...
        <div class="cirpic">
            <img class="small border" src="infosys.jpeg" width="500px">
            <img class="small border" src="tata.jpeg" width="500px" >
            <img class="small border" src="accenture.jpeg" width="500px">
            <img class="small border" src="google.jpeg" width="500px" >
    ...
    <header>
        ...
        <div class="search"><input type="text" placeholder="Enter to Search">
            ...
            <div class="contain">
                <table >
                    <tr>
                        <td><img src="/static/web.jpeg" height="200px" width="200px">
                            <p><b>WEB DESIGN<br>&nbsp;&nbsp;AND&nbsp;DEVELOPMENT</b><br>
                                
                               
                
                        </p></td>
                        <td><img src="/static/js.png" height="200px" width="200px"><br>
                            <p><b>JAVASCRIPT&nbsp;</b><br>
                        ...
                        <td><img src="/static/c.jpeg" height="200px" width="200px"><br>
                            <p><b>C/C++</b><br>
...
<head>
    ...
    <body>
        ...
        <div class="info">
            ...
            <b>Address: </b>Near Rama Thulasamma Convention Hall<br><br>
            <b>Email: </b>charithakamireddy@gmail.com<br><br>
            <b>Phone: </b>8125339942
        </div>
